...
def preprocess_image(image_path, img_size=224):
    ...
    Carga y preprocesa una imagen:
      - Abre la imagen (RGB)
      - La redimensiona a img_size x img_size
      - Normaliza los valores de píxeles al rango [-1, 1] (equivalente a (x/127.5)-1)
      - Transpone de HWC a CHW
...
def main():
    ...
    onnx_model_path = os.path.expanduser('~/codi/TFG/Fine-Tuning-MNV2_v3_cifar10/modelosFTuneados/mnv2_cifar10_bo_v1_simplified.onnx')
