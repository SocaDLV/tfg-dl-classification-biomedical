# Igual que testInferencia pero en este s'agarren 3000 imagens aleatories
...
def main():
    ...
    all_images = list(images_path.rglob('*.jpg'))
    image_files = random.sample(all_images, total_images)
