...
def main():
    ...
    data_dir = Path(r'C:\Users\Ivan\Desktop\Asignatures5tcarrera\TFG\codi\Fine-Tuning-MNV2_v2')  # Ruta al directorio del dataset
    ...
    unfreeze = 4            # era 92 pero es moltissim, passe a 20 -> 2/1/25 Canvi a 4
    ...
    unfreeze += 3            # 2/1/25 -> Era 8, canvi a 3, perq 8 pareix massa
    ...
    model.save(Path(r'C:\Users\Ivan\Desktop\Asignatures5tcarrera\TFG\codi\Fine-Tuning-MNV2_v2\v1_webMedium.com\ft_mobilenetv2_tinyin.h5'))
