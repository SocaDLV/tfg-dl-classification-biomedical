...
NUM_TRANSF_EPOCHS=20 # Number of training epochs for transferleaning   ORIGINAL era 20  ->5
NUM_FINETUNE_EPOCHS=5 # Number of training epochs for finetuning steps ORIGINAL era 5  ->2
...
RETRAIN=False
NUM_RETRAIN_EPOCHS=3              # ORIGINAL era 3 ->2
